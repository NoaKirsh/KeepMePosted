...
class TestCollectorWithMockedFeeds:
    ...
    async def test_collect_news_respects_max_articles(self, collector):
        ...
        for i in range(10):
            ...
            entry.published_parsed = (datetime.now(timezone.utc) - timedelta(hours=1)).timetuple()[
                :9
            ]
